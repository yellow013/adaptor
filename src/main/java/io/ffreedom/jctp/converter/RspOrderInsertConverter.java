...
public class RspOrderInsertConverter implements Converter<CThostFtdcInputOrderField, RspOrderInsert> {

	@Override
	public RspOrderInsert convert(CThostFtdcInputOrderField from) {
