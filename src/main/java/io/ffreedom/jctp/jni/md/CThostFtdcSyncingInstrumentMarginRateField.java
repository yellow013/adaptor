...
public class CThostFtdcSyncingInstrumentMarginRateField {
	...
	public void setLongMarginRatioByMoney(double value) {
		jctpmdapiv6v3v11x64JNI.CThostFtdcSyncingInstrumentMarginRateField_LongMarginRatioByMoney_set(swigCPtr, this,
				value);
	}

	public double getLongMarginRatioByMoney() {
		return jctpmdapiv6v3v11x64JNI.CThostFtdcSyncingInstrumentMarginRateField_LongMarginRatioByMoney_get(swigCPtr,
				this);
	}

	public void setLongMarginRatioByVolume(double value) {
		jctpmdapiv6v3v11x64JNI.CThostFtdcSyncingInstrumentMarginRateField_LongMarginRatioByVolume_set(swigCPtr, this,
				value);
	}

	public double getLongMarginRatioByVolume() {
		return jctpmdapiv6v3v11x64JNI.CThostFtdcSyncingInstrumentMarginRateField_LongMarginRatioByVolume_get(swigCPtr,
				this);
	}

	public void setShortMarginRatioByMoney(double value) {
		jctpmdapiv6v3v11x64JNI.CThostFtdcSyncingInstrumentMarginRateField_ShortMarginRatioByMoney_set(swigCPtr, this,
				value);
	}

	public double getShortMarginRatioByMoney() {
		return jctpmdapiv6v3v11x64JNI.CThostFtdcSyncingInstrumentMarginRateField_ShortMarginRatioByMoney_get(swigCPtr,
				this);
	}

	public void setShortMarginRatioByVolume(double value) {
		jctpmdapiv6v3v11x64JNI.CThostFtdcSyncingInstrumentMarginRateField_ShortMarginRatioByVolume_set(swigCPtr, this,
				value);
	}

	public double getShortMarginRatioByVolume() {
		return jctpmdapiv6v3v11x64JNI.CThostFtdcSyncingInstrumentMarginRateField_ShortMarginRatioByVolume_get(swigCPtr,
				this);
	}
