...
public class CThostFtdcInstrumentOrderCommRateField {
	...
	public void setOrderActionCommByVolume(double value) {
		jctpmdapiv6v3v11x64JNI.CThostFtdcInstrumentOrderCommRateField_OrderActionCommByVolume_set(swigCPtr, this,
				value);
	}

	public double getOrderActionCommByVolume() {
		return jctpmdapiv6v3v11x64JNI.CThostFtdcInstrumentOrderCommRateField_OrderActionCommByVolume_get(swigCPtr,
				this);
	}
