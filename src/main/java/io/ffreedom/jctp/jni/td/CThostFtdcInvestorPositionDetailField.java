...
public class CThostFtdcInvestorPositionDetailField {
	...
	public void setPositionProfitByDate(double value) {
		jctptraderapiv6v3v11x64JNI.CThostFtdcInvestorPositionDetailField_PositionProfitByDate_set(swigCPtr, this,
				value);
	}

	public double getPositionProfitByDate() {
		return jctptraderapiv6v3v11x64JNI.CThostFtdcInvestorPositionDetailField_PositionProfitByDate_get(swigCPtr,
				this);
	}

	public void setPositionProfitByTrade(double value) {
		jctptraderapiv6v3v11x64JNI.CThostFtdcInvestorPositionDetailField_PositionProfitByTrade_set(swigCPtr, this,
				value);
	}

	public double getPositionProfitByTrade() {
		return jctptraderapiv6v3v11x64JNI.CThostFtdcInvestorPositionDetailField_PositionProfitByTrade_get(swigCPtr,
				this);
	}
