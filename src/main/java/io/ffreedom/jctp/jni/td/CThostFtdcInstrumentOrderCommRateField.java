...
public class CThostFtdcInstrumentOrderCommRateField {
	...
	public void setOrderActionCommByVolume(double value) {
		jctptraderapiv6v3v11x64JNI.CThostFtdcInstrumentOrderCommRateField_OrderActionCommByVolume_set(swigCPtr, this,
				value);
	}

	public double getOrderActionCommByVolume() {
		return jctptraderapiv6v3v11x64JNI.CThostFtdcInstrumentOrderCommRateField_OrderActionCommByVolume_get(swigCPtr,
				this);
	}
