...
public class CThostFtdcInstrumentMarginRateAdjustField {
	...
	public void setLongMarginRatioByMoney(double value) {
		jctptraderapiv6v3v11x64JNI.CThostFtdcInstrumentMarginRateAdjustField_LongMarginRatioByMoney_set(swigCPtr, this,
				value);
	}

	public double getLongMarginRatioByMoney() {
		return jctptraderapiv6v3v11x64JNI.CThostFtdcInstrumentMarginRateAdjustField_LongMarginRatioByMoney_get(swigCPtr,
				this);
	}

	public void setLongMarginRatioByVolume(double value) {
		jctptraderapiv6v3v11x64JNI.CThostFtdcInstrumentMarginRateAdjustField_LongMarginRatioByVolume_set(swigCPtr, this,
				value);
	}

	public double getLongMarginRatioByVolume() {
		return jctptraderapiv6v3v11x64JNI
				.CThostFtdcInstrumentMarginRateAdjustField_LongMarginRatioByVolume_get(swigCPtr, this);
	}

	public void setShortMarginRatioByMoney(double value) {
		jctptraderapiv6v3v11x64JNI.CThostFtdcInstrumentMarginRateAdjustField_ShortMarginRatioByMoney_set(swigCPtr, this,
				value);
	}

	public double getShortMarginRatioByMoney() {
		return jctptraderapiv6v3v11x64JNI
				.CThostFtdcInstrumentMarginRateAdjustField_ShortMarginRatioByMoney_get(swigCPtr, this);
	}

	public void setShortMarginRatioByVolume(double value) {
		jctptraderapiv6v3v11x64JNI.CThostFtdcInstrumentMarginRateAdjustField_ShortMarginRatioByVolume_set(swigCPtr,
				this, value);
	}

	public double getShortMarginRatioByVolume() {
		return jctptraderapiv6v3v11x64JNI
				.CThostFtdcInstrumentMarginRateAdjustField_ShortMarginRatioByVolume_get(swigCPtr, this);
	}
