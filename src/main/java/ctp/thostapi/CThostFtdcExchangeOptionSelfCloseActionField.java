...
public class CThostFtdcExchangeOptionSelfCloseActionField {
	...
	public void setOptionSelfCloseLocalID(String value) {
		thosttraderapiJNI.CThostFtdcExchangeOptionSelfCloseActionField_OptionSelfCloseLocalID_set(swigCPtr, this,
				value);
	}

	public String getOptionSelfCloseLocalID() {
		return thosttraderapiJNI.CThostFtdcExchangeOptionSelfCloseActionField_OptionSelfCloseLocalID_get(swigCPtr,
				this);
	}
