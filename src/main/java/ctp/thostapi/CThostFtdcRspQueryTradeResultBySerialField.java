...
public class CThostFtdcRspQueryTradeResultBySerialField {
	...
	public void setOriginDescrInfoForReturnCode(String value) {
		thosttraderapiJNI.CThostFtdcRspQueryTradeResultBySerialField_OriginDescrInfoForReturnCode_set(swigCPtr, this,
				value);
	}

	public String getOriginDescrInfoForReturnCode() {
		return thosttraderapiJNI.CThostFtdcRspQueryTradeResultBySerialField_OriginDescrInfoForReturnCode_get(swigCPtr,
				this);
	}
